...
<section class="about">
   ...
   <div class="row">
      ...
      <div class="content">
         ...
         <p>Hey There ! I'm Sachin. A Student of BCA in Software Engineering Department from HIMT College [Batch : 2024] . I love designing websites and exploring new things. Learning new things is my hobby.</p>

         <p>I would like to thank <a href="https://www.facebook.com/narendrakumar.upadhyay.1?mibextid=ZbWKwL" target="_blank">Narendra Upadhyay</a> Sir for guiding me through the session and making me able to develop projects like this. </p>
...
<section class="reviews">
   ...
   <div class="swiper-wrapper">
      ...
      <div class="swiper-slide slide">
         ...
         <h3> <a href="https://www.instagram.com/yashsharma9843?igsh=MWNpbHB2dm12YXo1MQ==" target="_blank">Yash Sharam</a></h3>
      </div>
      ...
      <div class="swiper-slide slide">
         ...
         <h3><a href="https://www.instagram.com/sanjay_.kashyap._?igsh=MW9zZ2VxczVnbmduNA==" target="_blank">Sanjay Kumar</a></h3>
      </div>
      ...
      <div class="swiper-slide slide">
         ...
         <h3><a href="https://www.facebook.com/profile.php?id=100071406606727&mibextid=ZbWKwL" target="_blank">Kunal</a></h3>
      </div>
      ...
      <div class="swiper-slide slide">
         ...
         <h3><a href="https://www.instagram.com/navi_kantnloyp?igsh=azF3bXVxcGhuazl5" target="_blank">Navikant</a></h3>
      </div>
      ...
      <div class="swiper-slide slide">
         ...
         <h3><a href="https://www.facebook.com/ranjitchaudhary159" target="_blank">Sachin</a></h3>
      </div>
      ...
      <div class="swiper-slide slide">
         ...
         <h3><a href="https://www.facebook.com/pra.x.nil"  target="_blank">Rahul Kumar</a></h3>
      </div>
